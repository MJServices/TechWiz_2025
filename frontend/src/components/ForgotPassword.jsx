              ...
              <div className="text-left">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-4 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-lg rounded-xl border text-white placeholder-gray-400 focus:outline-none focus:border-purple-400/50 transition-all duration-300 disabled:opacity-50 ${
                      emailError ? 'border-red-400/50' : 'border-white/20'
                    }`}
                  />
                </div>
                {emailError && (
                  <motion.p
                    className="text-red-400 text-sm font-medium flex items-center mt-2"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  >
                    {emailError}
